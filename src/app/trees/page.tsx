    ...
    <>
      ...
      <main className="mx-auto w-full max-w-6xl flex-1 px-6 pt-28 pb-24">
        ...
        <p className="mt-3 text-[12px] text-[#6e6e73]">
          The tool is served from the team&apos;s own app, shown in its original colours so the
          street-level imagery reads true. On a phone, draw the area inside the frame.
        </p>
      </main>
    </>
  );
